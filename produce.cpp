	...
	for (int iEvt = 0; iEvt < nEvt; iEvt++) {
		...
		if (eventtimestamp > evtwindow) {
			...
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MC00",
							musc));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MCF1",
							targ_f));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MCS1",
							targ_s));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MC02",
							veto));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MCF3",
							sil1_f));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MCS3",
							sil1_s));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MCF4",
							sil2_f));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MCS4",
							sil2_s));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MC05",
							scl));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MCF6",
							sir1_f));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MCS6",
							sir1_s));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MCF7",
							sir2_f));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MCS7",
							sir2_s));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MC08",
							scr));
			gData->fPulseIslandToChannelMap.insert(
					pair<std::string, std::vector<TPulseIsland*> >("MC11",
							musca));
			mcdata.Fill();
